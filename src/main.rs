...
fn main() {
    ...
    match &cli.command {
        ...
        Commands::Server { bind_addr,save_shader_disable,save_shader_dir } => tokio::runtime::Builder::new_multi_thread()
            .enable_all()
            .build()
            .unwrap()
            .block_on(server::main(bind_addr,*save_shader_disable,save_shader_dir)),
    }
}
